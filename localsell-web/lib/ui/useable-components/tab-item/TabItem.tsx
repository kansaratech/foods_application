interface TabItemProps {
  ...
  export default function TabItem({ active, label, onClick, Icon }: TabItemProps) {
    const baseClasses =
      "flex flex-col sm:flex-row items-center justify-center min-h-11 flex-1 sm:flex-none sm:w-24 rtl:ml-2 md:rtl:ml-2 sm:w-36 gap-x-1 p-2 md:pt-2 md:pb-2 md:pl-4 md:pr-4 rounded-full cursor-pointer transition-all duration-300 whitespace-nowrap";
