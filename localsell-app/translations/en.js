export const en = {
  ...
  welcome:
    "Welcome to LocalSell, sometimes all you need is love. But a little food now and then doesn't hurt.",
  welcomeScreen: 'Welcome to LocalSell',
  loginBtn: 'Login',
  ...
  selectOptionforAddon: 'Please make a selection to continue',
  ...
  brandName: 'LocalSell',
  welcomeText: 'Welcome to LocalSell',
  createAccountDesc:
  ...
  exploreLocalSellCities: 'Explore LocalSell Cities',
  Card: 'Card',
  ...
  area_na_your_area: 'your area',
  area_na_title: "We're not in {{place}} yet",
  area_na_nearby: 'LocalSell is delivering in {{area}}, about {{km}} km away.',
  area_na_nearby_nodist: 'LocalSell is delivering in {{area}}.',
  area_na_nearby_generic: "We're expanding, one town at a time.",
  area_na_expand_more:
    "We're expanding fast — leave your details and we'll tell you the moment we launch near you.",
  area_na_success_title: "You're on the list",
  area_na_success_body: "We'll message you the day LocalSell reaches {{place}}.",
  area_na_email: 'Email address',
  area_na_phone: 'Phone number (optional)',
