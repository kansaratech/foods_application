export const PERMISSIONS = [
  ...
  { label: 'Transaction History', code: 'Transaction History' },
  { label: 'Earnings', code: 'Earnings' },
  { label: 'Audit Logs', code: 'Audit Logs' },
  { label: 'Waitlist', code: 'Waitlist' },
  { label: 'Store Performance', code: 'Store Performance' },
  { label: 'Store Documents', code: 'Store Documents' },
