  ...
  return !isLoading ? (
    <div className="flex flex-col gap-2">
      ...
      <div className="relative flex items-center justify-between">
        {/* Decrease */}
        <div
          className="absolute left-2 z-10 flex h-6 w-6 cursor-pointer select-none items-center justify-center rounded-full border border-surface-border dark:hover:bg-dark-600 hover:bg-slate-200"
        ...
        {/* Increase */}
        <div
          className="absolute right-2 z-10 flex h-6 w-6 cursor-pointer select-none items-center justify-center rounded-full border border-surface-border hover:bg-slate-200 dark:hover:bg-dark-600"
